using Doctor_Appointment.DTO.Roles;
...
namespace Doctor_Appointment.Controllers
{
    ...
    public class RolesController : BaseAPIController
    {
        ...
        public async Task<IHttpActionResult> Create(CreateRoleModel createRoleModel)
        {
            ...
            var result = await this.AppRoleManager.CreateAsync(roles);
            ...
            Uri locationHeader = new Uri(Url.Link("GetRoleById", new { id = roles.Id }));

            return Created(locationHeader, TheModelFactory.CreateRole(roles));
        }
