...
namespace Doctor_Appointment
{
    public static class JwtManager
    {
        ...
        private const string Secret1 = "db3OIsj+BXE9NZDy0t8W3TcNekrF+2d/1sFnWG4HnV8TZY30iTOdtVWJG8abWvB1GlOgJuQZdcF2Luqm/hccMw==";

        public static string GenerateToken1(string username, int expireMinutes = 20)
        {
            var symmetricKey = Convert.FromBase64String(Secret1);
            var tokenHandler = new JwtSecurityTokenHandler();
